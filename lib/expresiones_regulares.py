...
def switch_buscador_lexemas(cadena): # Simulación de switch para buscar lexemas en lista.
    ...
    print(lexema_tipoDeDato.findall(cadena))
    print(lexema_arimetico.findall(cadena))
    print(lexema_logico.findall(cadena))
    print(lexema_asignacion.findall(cadena))
